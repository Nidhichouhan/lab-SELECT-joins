...
INNER JOIN SKILL4 ON PROFILE_SKILLS.SKILL_ID=SKILL4.ID
WHERE SKILL4.NAME='PROGRAMMING'
ORDER BY USER_NEW.NAME;
...
SELECT USER_NEW.NAME, EVENT1.NAME
FROM USER_NEW
